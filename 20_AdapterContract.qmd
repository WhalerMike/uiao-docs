...
This specification builds upon and formalizes the adapter registry defined in [`13_FIMF_AdapterRegistry.qmd`](./13_FIMF_AdapterRegistry.qmd).
...
- All outputs must be identity-rooted and carry a valid Provenance Record (see `15_ProvenanceProfile.qmd`)
...
2. Submission to UIAO Adapter Registry (`13_FIMF_AdapterRegistry.qmd`)
...
**Cross-references:**
- [`13_FIMF_AdapterRegistry.qmd`](./13_FIMF_AdapterRegistry.qmd) -- Registry and discovery
- [`16_DriftDetectionStandard.qmd`](./16_DriftDetectionStandard.qmd) -- Drift taxonomy and remediation
- [`15_ProvenanceProfile.qmd`](./15_ProvenanceProfile.qmd) -- Mandatory provenance record
- [`19_ReconciliationModel.qmd`](./19_ReconciliationModel.qmd) -- Conflict resolution for multi-source claims
